...
antonym: convict (一起胜利，一起征服，宣判有罪)

convict sb of sth



addle ['ædl] vt 使困惑 vi 变质腐烂 a 糊涂的
...
deft 玩弟弟(d)左手(left)熟练 (de + ept = dept => deft)

adroit from drive，加强驱动，熟练
...
reject [rɪ'dʒekt] vt 拒绝

往回扔 = 拒绝

deject [dɪ'dʒekt] vt 使沮丧

往下扔

abject ['æbdʒɛkt] a 卑鄙，可怜

远离扔，被扔远，被晾到一边 = 可怜 = 可恨，卑鄙

conjecture [kən'dʒektʃə] v/n 猜测预测
...
diurnal [daɪ'ɜːn(ə)l] a. 白天的

di from day

nocturnal [nɒk'tɜːn(ə)l] a. 夜晚的

noc from night



adulterate [ə'dʌltəreɪt] vt 掺假
...
superfluous [suː'pɜːflʊəs] a. 过剩的

超级流动 = 过剩的

super 1.超级 2.上面 3.过多

effluvia [ɪ'flʊvjə] n. 臭气 (单数：effluvium)
...
slay 死嘞 = 杀死，vt =kill （from slaughter）slay-slew-slain
...
enmity n 敌意 syn hostile 对主人有敌意 a



enamor vt 使迷恋 [ɪn'æmɚ]
...
amphibian [æm'fɪbɪən] a/n 两栖动物

amphi- ambi 1.周围，到处 2. 二
...
ambidextrous a 双手灵巧的 [,æmbɪ'dekstrəs]
...
notorious a 臭名昭著的 [nə(ʊ)'tɔːrɪəs]
...
cogitate vt vi 仔细考虑谋划 ['kɒdʒɪteɪt]
...
arboretum [,ɑːbə'riːtəm] n 植物园

arbor  arb  树 tree，from herb

arbor n 树荫 凉亭 harbor
...
errant ['er(ə)nt] a 错误的

erroneous a [ɪ'rəʊnɪəs] 错误的

一个one 错误

inerrancy n [ɪn'ɛrənsi] 无差错，正确
...
artful a 人狡猾的 同义 cunning，sly

人很有skill

artless a 人淳朴的 without artificiality
...
advert v 注意 联想advertisement

revert v 回到原话题 re back. revert to sth 回到

divert v 转开 di apart 另义 娱乐

pervert v n 变态 per through 一直在转变

controvert v contro 反 反驳

subvert v 从底下转变 颠覆破坏
...
perverse a 任性的 善变的 变态的

controversy n 争议

subversive a 破坏性的 颠覆性的
...
equivocal a 声音相同 = 模棱两可的 ambiguous

vociferous a fer 搬，带 带来声音 = 吵闹的

provoke v 在前面喊 = 激怒

revoke v 喊回来 revoke my order 取消收回命令
